...
date: "Due date: 11:59am on Sunday, May 10th, 2026"
output: 
...
```{r}
source("https://raw.githubusercontent.com/linnykos/561_s2026_public/main/HW2_files/random_graph_functions.R")
...
6. Set default values of `n`, `clique_fraction` and `clique_edge_density`.
...
knitr::include_graphics("https://raw.githubusercontent.com/linnykos/561_s2026_public/main/HW3_files/partial-clique.png")
```
...
knitr::include_graphics("https://github.com/linnykos/561_s2026_public/blob/main/HW3_files/check1_editted.png?raw=true")
```
...
knitr::include_graphics("https://github.com/linnykos/561_s2026_public/blob/main/HW3_files/check2_editted.png?raw=true")

```

```{r, echo=TRUE, out.width = "400px", fig.align="center", echo = FALSE, fig.cap=c("First screenshot in Question 4C.")}
knitr::include_graphics("figures/check_first_20.png")
```

```{r, echo=TRUE, out.width = "400px", fig.align="center", echo = FALSE, fig.cap=c("Second screenshot in Question 4C.")}
knitr::include_graphics("figures/check_last_20.png")
```
...
The full project specifications will be released in a few weeks. To give you a sense of what to expect, you'll be making a PkgDown website that looks like [https://linnykos.github.io/561_s2026_example/](https://linnykos.github.io/561_s2026_example/). Briefly, this will involve:
...
<div style="border-left: 4px solid #4A90D9; padding-left: 10px;">
For my final project, I want to build an R package for numerical integration. The package would implement Riemann sums, the trapezoidal rule or other integration rules, and compare its accuracy on example functions with known exact integrals.
</div>
